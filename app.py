...
df_1=pd.read_csv("first_telc_1.csv")
...
def predict():
    ...
    new_df__dummies = pd.get_dummies(data=df_2, columns=['gender', 'Partner', 'Dependents', 'PhoneService',
           'MultipleLines', 'InternetService', 'OnlineSecurity', 'OnlineBackup',
           'DeviceProtection', 'TechSupport', 'StreamingTV', 'StreamingMovies',
           'Contract', 'PaperlessBilling', 'PaymentMethod','tenure_group'],
                  )

    # drop_columns = ['Unnamed: 0','Dependents_','MultipleLines_','Partner_', 'PhoneService_', 'InternetService_', 'OnlineSecurity_', 'OnlineBackup_', 'DeviceProtection_',
    #                   'TechSupport_', 'StreamingTV_', 'StreamingMovies_', 'Contract_', 'PaperlessBilling_', 'PaymentMethod_']
    drop_columns = ['Unnamed: 0']
    for column in drop_columns:
        new_df__dummies.drop(columns=[column], axis=1, inplace=True)
